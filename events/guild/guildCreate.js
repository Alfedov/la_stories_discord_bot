...
logging2.moderation.mute_role = muteRole.id
    ...
    if(textChats){
      ...
      .setColor('PURPLE')
      .setDescription(`Hey Poggers! I'm **a Bot**.\n\nThank you for inviting me to your server as it means a lot to us! You can get started with [\`!help\`](https://${jsconfig.domain}) & customise your server settings by accessing the Dashboard [\`here\`](https://${jsconfig.domain}/dashboard/${guild.id}).\n\n__**Current News**__\n\`\`\`\nWe are currently giving premium to all servers until 1000 guilds! If interested Please visit https://${jsconfig.domain}/redeem\`\`\`\n\nAgain, thank you for inviting me! (this server is now very pog)\n****`)
